...
| **Twemoji** | `emoji_font` | Twitter's emoji set as a colour font — the flat, friendly look used across the web. A COLRv0 build of Twemoji 17.0.2, so it draws in colour on Android 8 and newer and covers the whole emoji catalogue. | — | [`fonts/twemoji.ttf`](fonts/twemoji.ttf) |
...
| **Emojitwo** | `emoji_font` | The open-source Emojitwo emoji set (fork of EmojiOne 2.2) as a COLRv0 colour font — flat, friendly vector emojis. The project stopped at Unicode 9, so emoji added since (and every ZWJ sequence) are drawn in your phone's own emoji font instead. | — | [`fonts/emojitwo.ttf`](fonts/emojitwo.ttf) |
