...
def sakura_breeze() -> dict:
    return {
        ...
        # The scallop carries through: popup, tools and chips all take the
        # petal edge; menus and cards fall back to rounded on their own.
        "popupShape": "SCALLOP",
        "popupBorderColor": c(0xFFED89A3),
        "popupBorderWidthDp": 1.0,
        "chipBackground": c(0xB8FFFFFF),
        "chipShape": "SCALLOP",
        "chipBorderColor": c(0x66E86A8C),
        "chipBorderWidthDp": 1.0,
...
def synthwave_highway() -> dict:
    return {
        ...
        "popupBorderWidthDp": 1.0,
        # Everything leans: keys, popup, tools and chips all take the slant.
        # The list menus and panel cards stay on the safe automatic shape —
        # a slanted menu clips its own rows.
        "toolShape": "SLANT",
        "toolWidthDp": 52,
        ...
        "chipShape": "SLANT",
        "chipBorderColor": c(0xFFFF2DAF),
        "chipBorderWidthDp": 1.0,
        "chipActiveBackground": c(0xFF2A1C5E),
        "chipActiveText": c(0xFF9AE8FF),
        "assets": {},
